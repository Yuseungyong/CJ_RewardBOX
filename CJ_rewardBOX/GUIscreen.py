...
class MyMplCanvas(FigureCanvas):
    def __init__(self, parent=None, width=5, height=1.2, dpi=100):
        fig = Figure(figsize=(width, height), dpi=dpi)
        
        self.axes = fig.add_subplot(111, xlim=(0, 100), ylim=(50, 200))
...
class AnimationWidget(QWidget):
    def __init__(self):
        ...
        vbox = QVBoxLayout()
        self.canvas = MyMplCanvas(self, width=10, height=2.4, dpi=100)
