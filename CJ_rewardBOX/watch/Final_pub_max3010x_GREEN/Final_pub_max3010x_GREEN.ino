...
const char* ssid = "gaeseung";
const char* password = "qpalzmvv";
const char* mqtt_server = "192.168.137.127";
...
void loop() {
  ...
  if (checkForBeat(greenValue) == true)
  {
    ...
    int on_pixels = (beatAvg + 5) / 15; //number of used LEDs: for 60 BPM, 3 LEDs will be on, for 120 - 6 etc
